	  ...
	  public void CancelPrepayWithinDeadLine(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
	           ...
	           try{
				...
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Log-In.jpg");

		} catch (Exception e) {
			
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Log-In.jpg");
		...
		logger.info("Searching Customer");
		     ...
		     try {
				test.log(LogStatus.INFO, "Navigating to customer search page");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-Search.jpg");
				...
				rep.endTest(test);
				rep.flush();
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-Search.jpg");
				errorpath=Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-Search.jpg";
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-list.jpg");
				...
				test.log(LogStatus.PASS, "Customer Selected");
				    ...
				    obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-list.jpg");
				    errorpath=Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-list.jpg";
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Booking-Channel-filters.jpg");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_Deadline/Search-Result_Deadline.jpg");
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Search-Result.jpg");
				errorpath=Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Search-Result.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
				...
				try {
				    ...
				    Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Room-Selection.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/booking-Details.jpg");
					...
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/booking.jpg");
				...
				try {
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Proceed-To-Cancellation.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Confirm-Cancellation.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/After-Cancel.jpg");
					test.log(LogStatus.PASS, "Cancellation PrePay Within DeadLine");
					logger.info("Completed Cancellation PrePay Within DeadLine");

				} catch (Exception e) {
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Cancel.jpg");
