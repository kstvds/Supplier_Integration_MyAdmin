	  ...
	  public void CancelPrepay(String browsername) throws Exception {
		...
		logger.info("Searching Customer");
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay/Booking-Channel-filters.jpg");
				...
				try {
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay/Confirm-Cancellation.jpg");
