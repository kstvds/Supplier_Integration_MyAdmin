		...
		logger.info("Searching Customer");
			 ...
			 try{
				...
				try {
					...
					driverqa.findElement(NewAccoBooking.paxFnameCHILD).sendKeys(excel.getData(3, 23, 1));
					Thread.sleep(1000);
					driverqa.findElement(NewAccoBooking.paxLnameCHILD).sendKeys(excel.getData(3, 23, 2));
