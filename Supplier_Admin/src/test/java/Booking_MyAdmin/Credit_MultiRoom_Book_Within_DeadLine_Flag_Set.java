	  ...
	  public void BookCreditMultiRoomwithinDeadlineFlagset(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
	           ...
	           try{
				...
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Log-In.jpg");
				...
				driverqa.findElement(Others.SupplierChannel).click();
				  ...
				  String elementval = driverqa.findElement(Others.SetFlag).getAttribute("class");
				   ...
				   if(elementval.equals( "has-switch switch-animate switch-off" ))
				   {
					   ...
					   Thread.sleep(2000);
					   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Before-Flag-Update.jpg");
					   driverqa.findElement(Others.Updatechannel).click();
					   Thread.sleep(2000);
					   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Flag-Set.jpg");
			  ...
			  logger.info("Searching Customer");
			     ...
			     try {
					test.log(LogStatus.INFO, "Navigating to customer search page");
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Customer-Search.jpg");
				 ...
				 try {
					...
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Customer-list.jpg");
				 ...
				 try{
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Search-Hotel-filters.jpg");
					 ...
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Booking-Channel-filters.jpg");
					 ...
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Search-Result.jpg");
					...
					try {
						test.log(LogStatus.INFO, "Starting Hotel Book Credit MultiRoom Within DeadLine");
						 ...
						 Thread.sleep(2000);
						 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Room-Selection.jpg");
