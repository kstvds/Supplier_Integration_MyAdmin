		...
		logger.info("Searching Customer");
			 ...
			 try{
				...
				try {
					...
					driverqa.findElement(NewAccoBooking.paxFname).sendKeys(excel.getData(2, 13, 0));
					Thread.sleep(2000);
					driverqa.findElement(NewAccoBooking.paxLname).sendKeys(excel.getData(2, 13, 1));
					Select passengertitle = new Select(driverqa.findElement(NewAccoBooking.paxtitle));
					passengertitle.selectByIndex(1);
					driverqa.findElement(NewAccoBooking.paxFname2).sendKeys(excel.getData(2, 14, 0));
					Thread.sleep(1000);
					driverqa.findElement(NewAccoBooking.paxLname2).sendKeys(excel.getData(2, 14, 1));
					...
					String expectedhoteltitle=excel.getData(2, 7, 0);
					...
					String expectedStartDate=excel.getData(2, 17, 0);
					...
					String expectedEndDate= excel.getData(2, 18, 0);
