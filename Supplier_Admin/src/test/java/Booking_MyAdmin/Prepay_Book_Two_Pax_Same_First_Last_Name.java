	  ...
	  public void BookPrepaySameFirstLastNameTwoPax(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
	           ...
	           try{
				...
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Log-In.jpg");

		} catch (Exception e) {
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Log-In.jpg";
		...
		logger.info("Searching Customer");
		     ...
		     try {
				test.log(LogStatus.INFO, "Navigating to customer search page");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Customer-Search.jpg");
			
			} catch (Exception e) {
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Customer-Search.jpg");
				test.log(LogStatus.FAIL, "Navigation to customer search page");
				errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Customer-Search.jpg";
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Customer-list.jpg");
				...
				test.log(LogStatus.PASS, "Customer Selected");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Customer-list.jpg");
					test.log(LogStatus.FAIL, "Customer Selection");
					errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Customer-list.jpg";
					logger.info(e.getMessage());
					test.log(LogStatus.FAIL, e.getMessage());
					rep.endTest(test);
					rep.flush();
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Booking-Channel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Search-Result.jpg");
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Search-Result.jpg");
				errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Search-Result.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
				...
				try {
					...
					Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Room-Selection.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Passenger-Details.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/Confirm-Same-Name.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/booking-Details.jpg");
					...
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/booking.jpg");
					errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Prepay_Two_Pax_Same_First_Last_Name/booking.jpg";
					logger.info(e.getMessage());
					test.log(LogStatus.FAIL, e.getMessage());
					rep.endTest(test);
					rep.flush();
