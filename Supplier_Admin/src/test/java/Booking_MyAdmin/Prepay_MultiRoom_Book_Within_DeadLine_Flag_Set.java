			...
			Assert.assertTrue(false, e.getMessage());
				...
				driverqa.findElement(Others.SupplierChannel).click();
				  ...
				  String elementval = driverqa.findElement(Others.SetFlag).getAttribute("class");
				   ...
				   if(elementval.equals( "has-switch switch-animate switch-off" ))
				   {
					   ...
					   Thread.sleep(2000);
					   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Within_DeadLine_Flag_Set/Before-Update-Flag.jpg");
					   driverqa.findElement(Others.Updatechannel).click();
					   Thread.sleep(2000);
					   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Within_DeadLine_Flag_Set/Flag-Set.jpg");
			  ...
			  logger.info("Searching Customer");
				 ...
				 try {
					...
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Within_DeadLine_Flag_Set/Customer-list.jpg");
				 ...
				 try{
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Within_DeadLine_Flag_Set/Search-Hotel-filters.jpg");
					 ...
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Within_DeadLine_Flag_Set/Booking-Channel-filters.jpg");
					...
					try {
						test.log(LogStatus.INFO, "Starting Hotel Book PrePay MultiRoom Within DeadLine");
						 ...
						 Thread.sleep(2000);
						 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Within_DeadLine_Flag_Set/Room-Selection.jpg");
