	  ...
	  public void BookCreditCardMultiSupplier(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
	           ...
	           try{
				...
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Log-In.jpg");
		...
		logger.info("Searching Customer");
		     ...
		     try {
				test.log(LogStatus.INFO, "Navigating to customer search page");
				 ...
				 Thread.sleep(3000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Customer-Search.jpg");
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Customer-list.jpg");
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Search-Hotel-Supplier-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Booking-Channel-Supplier-filters.jpg");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Search-Result-Supplier.jpg");
				...
				try {
					test.log(LogStatus.INFO, "Starting Hotel Save Itenary for Supplier Room");
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Room-Selection-Supplier.jpg");
					...
					Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Passenger-Details-Supplier.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Itenary-Details-Supplier.jpg");
				...
				try {
					...
					childage.selectByIndex(5);
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Search-Hotel-filters-DOTW.jpg");
					 wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.bookChannel));
					 driverqa.findElement(NewAccoBooking.bookChannel).click();
					 ...
					 Thread.sleep(2000);
					 wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.searchButton));
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Booking-Channel-filters-DOTW.jpg");
					 driverqa.findElement(NewAccoBooking.searchButton).click();
					 wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyresultHotel));
					 String result= driverqa.findElement(NewAccoBooking.thirdPartyresultHotel).getText();
					 Thread.sleep(2000);
					 ...
					 driverqa.findElement(NewAccoBooking.thirdPartyroomType).click();
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Search-Result-DOTW.jpg");
					 Assert.assertTrue(result.contains(expected));
				...
				try {
					test.log(LogStatus.INFO, "Starting Hotel Save Itenary for DOTW Room");
					 ...
					 driverqa.findElement(NewAccoBooking.thirdPartyroomSelectionsaveoutdead).click();
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Room-Selection-DOTW.jpg");
					 wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyprocedetoBooksaveoutdead));
					 driverqa.findElement(NewAccoBooking.thirdPartyprocedetoBooksaveoutdead).click();
					 logger.info("Entering Passenger details");
					 test.log(LogStatus.INFO, "Entering Passenger details");
					...
					driverqa.findElement(NewAccoBooking.acceptChkBX).click();
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Passenger-Details-DOTW.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Itenary-Details-DOTW.jpg");
				...
				try {
					test.log(LogStatus.INFO, "Starting Hotel Book from Saved Itenary Multi Supplier");
					 ...
					 driverqa.findElement(PaymentPage.ccNum).sendKeys(excel.getData(2, 22, 0));
					 driverqa.findElement(PaymentPage.cvv).sendKeys(excel.getData(2, 22, 1));
					 driverqa.findElement(PaymentPage.ccName).sendKeys(excel.getData(2, 22, 2));
					 ...
					 driverqa.findElement(PaymentPage.zip).sendKeys(excel.getData(2, 25, 0));
					 driverqa.findElement(PaymentPage.termsconditions).click();
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Card-Details.jpg");
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_MultiSupplier/Booking-Details.jpg");
				} catch (Exception e) {
					logger.info(e.getMessage());
					test.log(LogStatus.FAIL, e.getMessage());
					rep.endTest(test);
