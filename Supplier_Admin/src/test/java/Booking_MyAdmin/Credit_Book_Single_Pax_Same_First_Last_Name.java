	 ...
	 @Parameters({ "browsername" })
	  public void BookCreditSameFirstLastName(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
			...
			errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Log-In.jpg";
		...
		logger.info("Searching Customer");
		     ...
		     try {
				...
				errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-Search.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-list.jpg");
				...
				test.log(LogStatus.PASS, "Customer Selected");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-list.jpg");
					...
					errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-list.jpg";
					logger.info(e.getMessage());
					test.log(LogStatus.FAIL, e.getMessage());
					rep.endTest(test);
					rep.flush();
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Booking-Channel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Search-Result.jpg");
				...
				errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Search-Result.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
				...
				try {
					test.log(LogStatus.INFO, "Starting Hotel Book Credit Single PAX with Same First and Last Name");
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Room-Selection.jpg");
					...
					Thread.sleep(1000);
					driverqa.findElement(NewAccoBooking.paxLname2).sendKeys(excel.getData(0, 14, 1));
					...
					Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Passenger-Details.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/booking-Details.jpg");
					...
					errorpath=Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Save-Itenary.jpg";
					logger.info(e.getMessage());
					test.log(LogStatus.FAIL, e.getMessage());
					rep.endTest(test);
					rep.flush();
