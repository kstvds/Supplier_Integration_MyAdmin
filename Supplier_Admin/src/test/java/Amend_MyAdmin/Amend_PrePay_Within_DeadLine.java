	  ...
	  public void AmendPrepayWithinDeadLine(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
	           ...
	           try{
				...
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Log-In.jpg");

		} catch (Exception e) {
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Log-In.jpg");
		...
		logger.info("Searching Customer");
		     ...
		     try {
				test.log(LogStatus.INFO, "Navigating to customer search page");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Customer-Search.jpg");
			
			} catch (Exception e) {
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Customer-Search.jpg");
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Customer-list.jpg");
				...
				test.log(LogStatus.PASS, "Customer Selected");
				   ...
				   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Customer-list.jpg");
					test.log(LogStatus.FAIL, "Customer Selection");
					errorpath=Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Customer-list.jpg";
					logger.info(e.getMessage());
					test.log(LogStatus.FAIL, e.getMessage());
					rep.endTest(test);
					rep.flush();
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Booking-Channel-filters.jpg");
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Search-Result.jpg");
				errorpath=Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Search-Result.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
				...
				try {
				    ...
				    Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Room-Selection.jpg");
					...
					Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Passenger-Details.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/booking-Details.jpg");
					...
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Booking.jpg");
				...
				try {
					...
					Thread.sleep(3000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/AmendPage.jpg");
					driverqa.findElement(Amend.proceedAmend).click();
					wait.until(ExpectedConditions.visibilityOfElementLocated(Amend.confirmAmend));
					Thread.sleep(3000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Confirm-AmendPage.jpg");
					...
					Thread.sleep(3000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Procced-To-AmendPage.jpg");
					...
					//String newoccupancy = driverqa.findElement(Amend.AfterAmendOccupancyPrePay).getText();
                   ...
                   String newOutdate = driverqa.findElement(Amend.verifysupplierChkoutPrePayafteramend).getText();
					...
					Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/After-Amend.jpg");

				} catch (Exception e) {
					test.log(LogStatus.FAIL, "Hotel Amend Prepay Within DeadLine");
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Amending.jpg");
