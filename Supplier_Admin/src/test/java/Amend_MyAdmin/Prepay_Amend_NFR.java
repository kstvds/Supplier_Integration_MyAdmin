	  ...
	  public void BookPrepay(String browsername) throws Exception {
		...
		logger.info("Searching Customer");
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Booking-Channel-filters.jpg");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Search-Result-Deadline And NFR.jpg");
				...
				try {
					...
					Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Passenger-Details.jpg");
