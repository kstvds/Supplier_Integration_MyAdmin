		...
		logger.info("Searching Customer");
		     ...
		     try {
				test.log(LogStatus.INFO, "Navigating to customer search page");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Customer-Search.jpg");
				...
				rep.endTest(test);
				rep.flush();
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card_NFR/Customer-Search.jpg");
				Assert.assertTrue(false, e.getMessage());
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Customer-list.jpg");
				...
				test.log(LogStatus.PASS, "Customer Selected");
					...
					rep.flush();
					Assert.assertTrue(false, e.getMessage());
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card_NFR/Customer-list.jpg");
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Booking-Channel-filters.jpg");
				 ...
				 String expecteddeadline=excel.getData(8, 19, 0);
				 String expectedNFR=excel.getData(8, 21, 0);
				...
				try {
					test.log(LogStatus.INFO, "Starting Hotel Save Itenary");
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Room-Selection.jpg");
					...
					driverqa.findElement(NewAccoBooking.paxFname).sendKeys(excel.getData(8, 13, 0));
					Thread.sleep(2000);
					driverqa.findElement(NewAccoBooking.paxLname).sendKeys(excel.getData(8, 13, 1));
					Select passengertitle = new Select(driverqa.findElement(NewAccoBooking.paxtitle));
					passengertitle.selectByIndex(1);
					driverqa.findElement(NewAccoBooking.paxFname2).sendKeys(excel.getData(8, 14, 0));
					Thread.sleep(1000);
					driverqa.findElement(NewAccoBooking.paxLname2).sendKeys(excel.getData(8, 14, 1));
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Itenary-Details.jpg");
					...
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card_NFR/Save-Itenary.jpg");
				    ...
				    try {
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Confirm-Delete-Itenary-Details.jpg");
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Card_NFR/Deleted-Itenary-Details.jpg");
						String Deletesuccesstext= driverqa.findElement(NewAccoBooking.thirdPartyremovefromcartconfirmtext).getText();
						String expectedDeletesuccesstext= excel.getData(8, 20, 0);
						...
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Card_NFR/Delete-Itenary.jpg");
