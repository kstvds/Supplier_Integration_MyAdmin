	  ...
	  public void SavePrepayWithinDeadLine(String browsername) throws Exception {
		...
		logger.info("Searching Customer");
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_Within_DeadLine/Customer-list.jpg");
			 ...
			 try{
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_Within_DeadLine/Booking-Channel-filters.jpg");
				...
				try {
					test.log(LogStatus.INFO, "Starting Hotel Save Itenary");
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_Within_DeadLine/Room-Selection.jpg");
					...
					Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_Within_DeadLine/Passenger-Details.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_Within_DeadLine/Itenary-Details.jpg");
				    ...
				    try {
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_Within_DeadLine/Confirm-Delete-Itenary-Details.jpg");
