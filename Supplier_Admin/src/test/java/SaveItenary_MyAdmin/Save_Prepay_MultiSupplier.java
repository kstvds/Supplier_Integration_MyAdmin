	 ...
	 @Parameters({ "browsername" })
	  public void SavePrepayMultiSupplier(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Log-In.jpg");
		...
		logger.info("Searching Customer");
		     ...
		     try {
				test.log(LogStatus.INFO, "Navigating to customer search page");
				 ...
				 Thread.sleep(3000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Customer-Search.jpg");
				...
				rep.endTest(test);
				rep.flush();
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Customer-Search.jpg");
				Assert.assertTrue(false, e.getMessage());
			 ...
			 try {
				 ...
				 driverqa.findElement(Operations.company).sendKeys(excel.getData(9, 4, 1));
				 Thread.sleep(2000);
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Customer-list.jpg");
				...
				test.log(LogStatus.PASS, "Customer Selected");
					...
					rep.flush();
					Assert.assertTrue(false, e.getMessage());
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Customer-list.jpg");
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Search-Hotel-Supplier-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Booking-Channel-Supplier-filters.jpg");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Search-Result-Supplier.jpg");
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Search-Result-Supplier.jpg");
			}
				...
				try {
					test.log(LogStatus.INFO, "Starting Hotel Save Itenary for Supplier Room");
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Room-Selection-Supplier.jpg");
					...
					Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Passenger-Details-Supplier.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Itenary-Details-Supplier.jpg");
					...
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Save-Itenary-Supplier.jpg");
				...
				try {
					...
					childage.selectByIndex(5);
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Search-Hotel-filters-DOTW.jpg");
					 wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.bookChannel));
					 driverqa.findElement(NewAccoBooking.bookChannel).click();
					 ...
					 Thread.sleep(2000);
					 wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.searchButton));
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Booking-Channel-filters-DOTW.jpg");
					 driverqa.findElement(NewAccoBooking.searchButton).click();
					 wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyresultHotel));
					 String result= driverqa.findElement(NewAccoBooking.thirdPartyresultHotel).getText();
					 Thread.sleep(2000);
					 ...
					 driverqa.findElement(NewAccoBooking.thirdPartyroomType).click();
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Search-Result-DOTW.jpg");
					 Assert.assertTrue(result.contains(expected));
					 ...
					 logger.info("Hotel Search Complete Prepay for DOTW Room");
						...
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Search-Result-DOTW.jpg");
					}
				try {
					test.log(LogStatus.INFO, "Starting Hotel Save Itenary for DOTW Room");
					 ...
					 driverqa.findElement(NewAccoBooking.thirdPartyroomSelectionsaveoutdead).click();
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Room-Selection-DOTW.jpg");
					 wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyprocedetoBooksaveoutdead));
					 driverqa.findElement(NewAccoBooking.thirdPartyprocedetoBooksaveoutdead).click();
					 logger.info("Entering Passenger details");
					 test.log(LogStatus.INFO, "Entering Passenger details");
					...
					driverqa.findElement(NewAccoBooking.acceptChkBX).click();
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Passenger-Details-DOTW.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Itenary-Details-DOTW.jpg");
				 ...
				 try {
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Confirm-Delete-1st-Itenary-Details.jpg");
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Deleted-1st-Itenary-Details.jpg");
						...
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Delete-1st-Itenary.jpg");
				 ...
				 try {
						...
						driverqa.findElement(NewAccoBooking.thirdPartyremovefromcart).click();
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Confirm-Delete-2nd-Itenary-Details.jpg");
						wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyconfirmremovefromcart));
						driverqa.findElement(NewAccoBooking.thirdPartyconfirmremovefromcart).click();
						wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyremovefromcartconfirmtext));
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Deleted-2nd-Itenary-Details.jpg");
						String Deletesuccesstext= driverqa.findElement(NewAccoBooking.thirdPartyremovefromcartconfirmtext).getText();
						String expectedDeletesuccesstext= excel.getData(9, 24, 1);
						System.out.println(Deletesuccesstext);
						System.out.println(expectedDeletesuccesstext);
						...
						driverqa.findElement(NewAccoBooking.CloseCancelBooking).click();
						Thread.sleep(3000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Deleted-full-itenary.jpg");
						...
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Delete-2nd-Itenary.jpg");
