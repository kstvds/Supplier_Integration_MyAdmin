		...
		logger.info("Searching Customer");
		     ...
		     try {
				test.log(LogStatus.INFO, "Navigating to customer search page");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_Deadline/Customer-Search.jpg");
				...
				rep.endTest(test);
				rep.flush();
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Within_Deadline/Customer-Search.jpg");
				errorpath=Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Within_Deadline/Customer-Search.jpg";
				Assert.assertTrue(false, e.getMessage());
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_Deadline/Customer-list.jpg");
				...
				test.log(LogStatus.PASS, "Customer Selected");
					...
					rep.flush();
					Assert.assertTrue(false, e.getMessage());
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Within_Deadline/Customer-list.jpg");
					errorpath=Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Within_Deadline/Customer-list.jpg";
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_Deadline/Search-Hotel-filters.jpg");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_Deadline/Booking-Channel-filters.jpg");
