		...
		logger.info("Searching Customer");
		     ...
		     try {
				test.log(LogStatus.INFO, "Navigating to customer search page");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Card/Customer-Search.jpg");
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Card/Customer-list.jpg");
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Card/Booking-Channel-filters.jpg");
